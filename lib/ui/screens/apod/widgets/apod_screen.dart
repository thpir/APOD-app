...
class _ApodScreenState extends State<ApodScreen> {
  ...
  Widget build(BuildContext context) {
    final apodViewModel = Provider.of<ApodViewModel>(context);
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'APOD app',
      ...
      body: FutureBuilder<Apod>(
          key: ValueKey(apodViewModel.apodFuture),
          future: apodViewModel.apodFuture,
          builder: (context, snapshot) {
            if (snapshot.hasError) {
              return ErrorView(
                ...
                child: IconButton(
                    onPressed: apodViewModel.fetchApod,
